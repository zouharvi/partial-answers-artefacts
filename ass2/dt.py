...
def process_data():
    """
    Return processed data from the assignment
    """
    ...
    return data, data_X, data_edb, data_col, data_siz, data_shp

if __name__ == "__main__":
    data, data_X, data_edb, data_col, data_siz, data_shp = process_data()

    # Decission tree
    dtc = DecisionTreeClassifier(criterion="entropy").fit(data_X, data_edb)
    ...
    print("mcc|small", confusion_matrix(
    ...
    print("mcc|large", confusion_matrix(
    ...
    print("mcc|small,round", confusion_matrix(
    ...
    print("mcc|small,irrgl", confusion_matrix(
    ...
    print("mcc|large,yellw", confusion_matrix(
    ...
    print("mcc|large,green", confusion_matrix(
    ...
    print("mcc|small,round,yellw", confusion_matrix(
    ...
    print("mcc|small,round,green", confusion_matrix(
    ...
    print("mcc|large,round,yellw", confusion_matrix(
        DummyClassifier(strategy="most_frequent").fit(data_edb_gsmall_ground_gyellw, data_edb_gsmall_ground_gyellw).predict(data_edb_gsmall_ground_gyellw), data_edb_gsmall_ground_gyellw)
    )
    print("mcc|large,irrgl,yellw", confusion_matrix(
