...
if __name__ == "__main__":
    ...
    dist_t_t = np.array(dist_t_t)
    dist_f_t = np.array(dist_f_t)
    dist_f_f = np.array(dist_f_f)
    dist_t_f = np.array(dist_t_f)

    print(np.average(dist_t_t, axis=0))
    print(np.average(dist_f_t, axis=0))
    print(np.average(dist_f_f, axis=0))
    print(np.average(dist_t_f, axis=0))